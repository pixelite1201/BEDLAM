...
requirements = (UtsnameNodename=!="g133" && UtsnameNodename=!="g144" && UtsnameNodename=!="g123" && UtsnameNodename=!="g135" && TARGET.CUDAGlobalMemoryMb>50000)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--script', type=str, default='/is/ps2/ppatel/HMR_train_smplx_release/trainx.py')
