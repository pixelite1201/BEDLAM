...
# && TARGET.CUDAGlobalMemoryMb>50000)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--script', type=str, default='/is/ps2/ppatel/HMR_train_smplx_release_camready/bedlam_cam_ready/train_hands.py')
    ...
    for i, log_path in enumerate(all_log_path):
        if args.test:
            jobname = log_path.split('/')[-1]+'_err5'
        elif args.cont:
            jobname = log_path.split('/')[-1]+'_cont4'
        else:
