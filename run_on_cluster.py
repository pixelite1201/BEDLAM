...
requirements = (UtsnameNodename=!="g133" && UtsnameNodename=!="g131" && UtsnameNodename=!="g137" && UtsnameNodename=!="g140" && UtsnameNodename=!="g174"  && UtsnameNodename=!="g103" && UtsnameNodename=!="g137" && UtsnameNodename=!="g144" && UtsnameNodename=!="g123" && UtsnameNodename=!="g135" && TARGET.CUDAGlobalMemoryMb>50000)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--script', type=str, default='/is/ps2/ppatel/HMR_train_smplx_release_camready/bedlam_cam_ready/train.py')
    parser.add_argument('--base_folder', type=str, default='/is/ps2/ppatel/HMR_train_smplx_release_camready/bedlam_cam_ready')
    parser.add_argument('--venv', type=str, default='/fast/ppatel/venv/bedlam_release')
   # parser.add_argument('--venv', type=str, default='/is/ps3/ppatel/.virtualenvs/BEDLAM_release2/')
    ...
    for i, log_path in enumerate(all_log_path):
        if args.test:
            jobname = log_path.split('/')[-1]+'_err_all'
        elif args.cont:
            jobname = log_path.split('/')[-1]+'_cont_msetol1'
        else:
